...
_COMMANDS = {
    ...
    "/engagement": "manage per-engagement scope/ROE files (create/use/close/targets/roe)",
    "/feed": "sync the skill feed — propose new intel/signatures through the gate",
    "/memory": "view the stack's deeper memory (facts distilled from lessons)",
    "/workflow": "list/show/run workflow playbooks — multi-worker chains (run is scope-gated)",
