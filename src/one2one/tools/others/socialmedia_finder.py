...
class FacialFind(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2022-02"
...
class SocialMediaFinderTools(One2OneToolsCollection):
