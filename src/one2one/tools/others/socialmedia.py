...
class BruteForce(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2021-10"
...
class SocialMediaBruteforceTools(One2OneToolsCollection):
