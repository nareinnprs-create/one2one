...
class Keydroid(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2022-04"
    TITLE = "Keydroid"
...
class LockPhish(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Upstream repo archived by author (last commit 2020-11)"
...
class EvilApp(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2018-12"
...
class AndroidAttackTools(One2OneToolsCollection):
