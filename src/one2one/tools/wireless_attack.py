...
class EvilTwin(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2018-07"
    TITLE = "EvilTwin"
    DESCRIPTION = (
...
class Fastssh(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2018-06"
    TITLE = "Fastssh"
    DESCRIPTION = (
...
class Howmanypeople(One2OneTool):
    TITLE = "Howmanypeople"
    DESCRIPTION = (
...
class WirelessAttackTools(One2OneToolsCollection):
