...
class Dracnmap(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2018-01"
    TITLE = "Dracnmap"
...
class XeroSploit(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2023-03"
    TITLE = "Xerosploit"
...
class ReconDog(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2021-01"
    TITLE = "ReconDog"
...
class Striker(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2023-06"
    TITLE = "Striker"
...
class TheHarvester(One2OneTool):
...
class InformationGatheringTools(One2OneToolsCollection):
