...
class Autophisher(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2022-08"
...
class Pyphisher(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Upstream repo removed/blocked (DMCA or suspended)"
    TITLE = "Pyphisher"
...
class ISeeYou(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2019-04"
    TITLE = "I-See_You"
    SUPPORTED_OS = ["linux"]
    DESCRIPTION = (
...
class Thanos(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Unmaintained — no commits since 2022-09"
    TITLE = "Thanos"
    SUPPORTED_OS = ["linux"]
...
class BlackPhish(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Upstream repo archived by author (last commit 2024-09)"
    TITLE = "BlackPhish"
    SUPPORTED_OS = ["linux"]
    INSTALL_COMMANDS = [
...
class PhishingAttackTools(One2OneToolsCollection):
