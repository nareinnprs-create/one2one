...
class GoldenEye(One2OneTool):
    ARCHIVED = True
    ARCHIVED_REASON = "Upstream repo archived by author (last commit 2023-11)"
    TITLE = "GoldenEye"
    SUPPORTED_OS = ["linux"]
    DESCRIPTION = (
...
class DDOSTools(One2OneToolsCollection):
