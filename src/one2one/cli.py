...
def show_help():
    console.print(Panel(
        Text.assemble(
            ...
            ("  /engagement ", "bold cyan"), ("manage per-engagement scope/ROE — create/use/close/targets/roe\n", "white"),
            ("  /feed     ", "bold cyan"), ("sync the skill feed — propose new intel/signatures through the gate\n", "white"),
            ("  /memory   ", "bold cyan"), ("view the stack's deeper memory — facts distilled from lessons\n", "white"),
            ("  /workflow ", "bold cyan"), ("list/show/run workflow playbooks — multi-worker chains (run is scope-gated)\n", "white"),
