...
- **Soliciting or sharing help with unauthorized, illegal hacking.** This is a toolkit
  for authorized security testing; using the community to coordinate attacks on systems
  you don't own or aren't permitted to test is not tolerated.
...
**https://github.com/nareinnprs-create/one2one/security/advisories/new**. All complaints will
